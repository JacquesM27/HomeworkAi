...
public sealed record ClosedAnswerExerciseResponsePassiveSideGenerated(ClosedAnswerExerciseResponsePassiveSide Exercise)
    : IEvent;
...
public sealed record ClosedAnswerExerciseResponseConditionalGenerated(ClosedAnswerExerciseResponseConditional Exercise)
    : IEvent;

public sealed record ClosedAnswerExerciseResponseWordMeaningGenerated(ClosedAnswerExerciseResponseWordMeaning Exercise)
    : IEvent;
