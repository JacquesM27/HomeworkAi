...
public sealed record OpenAnswerExerciseResponsePassiveSideGenerated
    (OpenAnswerExerciseResponsePassiveSide Exercise): IEvent;    

public sealed record OpenAnswerExerciseResponseParaphrasingGenerated
    (OpenAnswerExerciseResponseParaphrasing Exercise): IEvent;    
...
public sealed record OpenAnswerExerciseResponseConditionalGenerated
    (OpenAnswerExerciseResponseConditional Exercise): IEvent;    
...
public sealed record OpenAnswerExerciseResponseWordMeaningGenerated
    (OpenAnswerExerciseResponseWordMeaning Exercise): IEvent;       